...
function DropdownMenuContent({
  ...
  Pick<
    ...
    "sideOffset" | "align" | "alignOffset" | "side"
  >) {
  return (
    <DropdownMenuPrimitive.Portal>
      ...
      >
        <DropdownMenuPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-(--available-height) min-w-[8rem] origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-md border bg-popover p-1 text-popover-foreground shadow-md outline-none transition-[transform,scale,opacity] data-starting-style:scale-95 data-starting-style:opacity-0 data-ending-style:scale-95 data-ending-style:opacity-0",
            className
          )}
          {...props}
        />
